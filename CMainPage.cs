...
namespace CameraHumanDetection
{
	public partial class CMainPage : Form
	{
		...
		private ResizeAndQuality currentResizeAndQuality;
		...
		{
			if (this.currentResizeAndQuality == null)
				this.currentResizeAndQuality = new ResizeAndQuality();
			if (this.activeForm != this.currentResizeAndQuality)
				OpenChildForm(this.currentResizeAndQuality, this.panelBodyMiddle);
			this.activeForm = this.currentResizeAndQuality;
		}
